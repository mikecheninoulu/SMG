...
class REC_Processor(Processor):
    ...
    def create_submission(self,predPath):
        ...
        for inx in range(len(self.data_loader['test'].dataset.sample_name)):
            output_file.write(str(self.data_loader['test'].dataset.sample_name[inx]) + "," + str(rank[inx, -1]) + "\n")
        output_file.close()
        ...
        #if not os.path.exists(predPath):
            #os.makedirs(predPath)
        #output_filename = os.path.join(predPath, 'groundtruth_classification_validation.csv')
        #output_file = open(output_filename, 'w')

        #print(self.data_loader['test'].dataset.sample_name)
        #print(len(self.data_loader['test'].dataset.sample_name))
        #for inx in range(len(self.data_loader['test'].dataset.sample_name)):
            #output_file.write(str(self.data_loader['test'].dataset.sample_name[inx]) + "," + str(self.label[inx]) + "\n")
        #output_file.close()
